...
public class SubscriptionList extends AbstractMwsObject {
    ...
    private List<Subscription> member;
     ...
     */
    public List<Subscription> getMember() {
        if (member==null) {
            member = new ArrayList<Subscription>();
        }
        return member;
    }
     ...
     */
    public void setMember(List<Subscription> member) {
        this.member = member;
    }
     ...
     * @param values a {@link com.amazonservices.mws.subscriptions.model.Subscription} object.
     */
    public SubscriptionList withMember(Subscription... values) {
        List<Subscription> list = getMember();
     ...
     */
    public SubscriptionList(List<Subscription> member) {
        this.member = member;
    }    
