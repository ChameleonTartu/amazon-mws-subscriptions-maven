...
/**
 * DeregisterDestinationInput complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="DeregisterDestinationInput"&gt;
 *    &lt;complexContent&gt;
 ...
 * </pre>
 */
public class DeregisterDestinationInput extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/schema/Subscriptions/2013-07-01", "DeregisterDestinationInput",this);
    }
     ...
     */
    public DeregisterDestinationInput(String sellerId,String mwsAuthToken,String marketplaceId,Destination destination) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.marketplaceId = marketplaceId;
        this.destination = destination;
     ...
     * @param destination a {@link com.amazonservices.mws.subscriptions.model.Destination} object.
     */
    public DeregisterDestinationInput(String sellerId,String marketplaceId,Destination destination) {
        this.sellerId = sellerId;
        this.marketplaceId = marketplaceId;
        this.destination = destination;
    }
     ...
     * Default constructor.
     */
    public DeregisterDestinationInput() {
        super();
    }
